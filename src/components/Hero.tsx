        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#contact" className="px-8 py-3.5 bg-gradient-to-r from-blue-600 to-orange-600 hover:from-blue-700 hover:to-orange-700 text-white font-semibold rounded-full shadow-lg hover:shadow-blue-500/20 transition-all duration-300 flex items-center gap-2">
                Get Started <ArrowRight size={20} />
              </a>
              <a href="#portfolio" className="px-8 py-3.5 bg-slate-800 hover:bg-slate-700 text-white font-semibold rounded-full shadow-lg transition-all duration-300">
                View Our Work
              </a>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="relative aspect-[4/3] bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl overflow-hidden p-6">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-orange-500/10"></div>
              
              <div className="grid grid-cols-2 gap-4 h-full">
                <div className="flex flex-col gap-4">
                  <div className="flex-1 bg-slate-800 rounded-xl p-5 transform hover:scale-105 transition-transform duration-300 flex flex-col items-center justify-center gap-3">
                ...
                <div className="flex flex-col gap-4 mt-8">
                  ...
                  <div className="flex-1 bg-gradient-to-br from-blue-600/80 to-orange-600/80 rounded-xl p-5 transform hover:scale-105 transition-transform duration-300 flex flex-col items-center justify-center text-center">
